...
\end{itemize}
\end{block}
\only<8->{\begin{block}{We propose}
\begin{itemize}
	\item<8-> Dynamical modification of static parameters.
	\item<9-> Optimal values are switched according to detected motion intensity.
	\item<10-> Intensity is detected using spectrum analysis of acceleration signals.
\end{itemize}
\end{block}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
